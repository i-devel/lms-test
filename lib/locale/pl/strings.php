...
$_LANG['Account:'] = 'Konto:';
$_LANG['Contractor Add'] = 'Nowy kontrahent';
$_LANG['System event log level (0/1), 0 - disabled. Default: 1'] = 'poziom logowania zdarzeń systemowych (0/1), 0 - wyłączone. Domyślnie: 1';
$_LANG['Limit the events displayed on a single page in the system logs. Default: 100'] = 'Limit wyświetlanych zdarzeń na jednej stronie w logach systemowych. Domyślnie: 100';
$_LANG['module'] = 'moduł';
$_LANG['action'] = 'akcja';
$_LANG['No Results'] = 'Brak Wyników';
$_LANG['Select this option if you want to include the deleted user logs'] = 'zaznacz, jeżeli chcesz dołączyć logi skasowanych użytkowników';
$_LANG['Hide other users of the system log'] = 'Ukryj logi systemowe pozostałych użytkowników';
$_LANG['Viewing the system log'] = 'Przeglądanie logów systemowych';
$_LANG['Syslog'] = 'Logi systemowe';
$_LANG['Search customer'] = 'Szukaj klienta';
$_LANG['Search contractor'] = 'Szukaj kontrahenta';
$_LANG['Click to search contractor'] = 'Kliknij aby wyszukać kontrahenta';
$_LANG['Select contractor'] = 'Wybierz kontrahenta';
$_LANG['Contractor Info: $a'] = 'Informacje o Kontrahencie: $a';
$_LANG['Contractor Edit: $a'] = 'Edycja Kontrahenta: $a';
$_LANG['Enter bank account (optional)'] = 'Wprowadź numer konta bankowego (opcja)';
$_LANG['Address for correspondence'] = 'Adres do korespondencji';
$_LANG['Address of the company'] = 'Adres firmy';
$_LANG['Name and last name'] = 'Imię i nazwisko';
$_LANG['Company name'] = 'Nazwa firmy';
$_LANG['contractor'] = 'kontrahent';
$_LANG['Bank account'] = 'Konto bankowe';
$_LANG['Are you sure, you want to remove contractor $a from database ?'] = 'Jesteś pewien że chcesz usunąć kontrahenta $a z bazy danych ?';
$_LANG['Incorrect Contractor ID.'] = 'Niepoprawny identyfikator kontrahenta';
$_LANG['Contractor Remove: $a'] = 'Usunięcie Kontrahenta: $a';
...
$_LANG['contractors'] = 'kontrahenci';
$_LANG['List of Contractors'] = 'Lista kontrahentów';
$_LANG['New Contractor'] = 'Nowy kontrahent';
$_LANG['Allows you to add new contractor'] = 'Dodaj nowego kontrahenta';
$_LANG['List of Contractors Groups'] = 'Lista grup kontrahentów';
$_LANG['deposit'] = 'kaucja';
$_LANG['lease'] = 'dzierżawa';
$_LANG['it service'] = 'serwis it';
$_LANG['suspension'] = 'zawieszenie';
$_LANG['Invoice have no items.'] = 'Faktura nie ma żadnych pozycji.';
$_LANG['the value of the invoice:'] = 'wartość faktury:';
$_LANG['Are you sure that you want to convert a pro forma invoice ?'] = 'Jesteś pewien że chcesz konwertować fakturę pro forma ?';
$_LANG['Convert a proforma invoice to invoice'] = 'Konwertuj fakturę pro forma do faktury VAT';
$_LANG['Type of invoice:'] = 'Typ faktury:';
...
$_LANG['Pro Froma Invoices List'] = 'Lista faktur pro forma';
...
$_LANG['New Pro Forma Invoice'] = 'Nowa faktura Proforma';
...
$_LANG['Payment for invoice No. $a'] = 'Zapłata za fakturę VAT nr $a';
...
$_LANG['with pro forma invoice'] = 'z fakturą pro forma';
...
$_LANG['for Invoice No. $a'] = 'do Faktury VAT Nr $a';
$_LANG['for Pro Forma Invoice No. $a'] = 'do Faktury Pro Forma Nr $a';
...
$_LANG['Creation date'] = 'Data utworzenia';
$_LANG['Topic'] = 'Temat';
$_LANG['The last three entries'] = 'Ostatnie trzy wpisy';
